    ...
    chapters: [
      {
        ...
        skillFocus: 'Building Correct Sentences',
        activityName: 'Arrange the Words / Opinion Builder',
        activityDescription:
          'Arrange jumbled words into correct sentences, then complete and record sentence templates aloud.',
      },
      {
        id: 'm3c2',
        moduleId: 'm3',
        ...
        activityName: 'Sentence Completion',
        activityDescription:
          'Choose the correct verb form to complete each sentence, then record yourself saying the full sentence aloud.',
      },
      {
        id: 'm3c3',
        moduleId: 'm3',
        number: 3,
        title: 'Fluency and Guided Speaking',
        skillFocus: 'Fluency, Idea Organization & Guided Dialogue',
        activityName: '1-Minute Speaking / Guided Prompts / Video Role-Play',
        activityDescription:
          'Speak for 1 minute on a chosen topic, practice guided sentence prompts, then respond to a live-style video caller in 5 real-life scenarios.',
      },
    ],
  },
];
